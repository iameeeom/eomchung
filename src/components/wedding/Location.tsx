    ...
    <section className="px-8 py-12 text-center">
     ...
     {/* 버튼 영역 */}
      <div className="flex gap-2 mt-5">
        ...
        <a
          href="https://map.kakao.com/?urlX=525939.999999998&urlY=1106942.9999999993&urlLevel=3&itemId=1862136403&q=%EB%A3%A8%EC%9D%B4%EB%B9%84%EC%8A%A4%EC%BB%A8%EB%B2%A4%EC%85%98%20%EC%86%A1%ED%8C%8C%EB%AC%B8%EC%A0%95%EC%A0%90&srcid=1862136403&map_type=TYPE_MAP"
          target="_blank" rel="noreferrer"
          className="flex-1 py-3 rounded-xl bg-lime border border-lime/20 text-lime-foreground text-sm hover:opacity-90 transition text-center flex items-center justify-center font-medium shadow-md"
        >
          <MapPin className="inline h-4 w-4 mr-1 flex-shrink-0" />
